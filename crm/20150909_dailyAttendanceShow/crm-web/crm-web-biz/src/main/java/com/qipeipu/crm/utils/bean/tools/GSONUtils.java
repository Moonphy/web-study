...
public class GSONUtils {
    ...
    public static <T> T fromJson(String json, TypeToken<T> token, String datePattern) {
        ...
        try {
        	...
        	logger.error(json + " cant't revert " + token.getRawType().getName() + " 对象!", ex);
            return null;
        }
    }
    ...
    public static <T> T fromJson(String json, Class<T> clazz, String datePattern) {
        ...
        try {
        	...
        	logger.error(json + "can't revert " + clazz.getName() + " 对象!", ex);
            return null;
        }
    }
    ...
    public static String toJson(Object target, Type targetType, GsonBuilder builder) {
        ...
        try {
        	...
        	logger.warn("toJson " + target.getClass().getName() + " 转换 JSON 字符串时，发生异常！", ex);
