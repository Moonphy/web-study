...
var upload = function(opts){
    var options = $.extend(true,{
        ...
        //uptoken_key:通过uptoken获取的json，token的key
        //uptoken:'',//若未指定uptoken_url,则必须指定 uptoken ,uptoken由其他程序生成
        // unique_names: true, // 默认 false，key为文件名。若开启该选项，SDK为自动生成上传成功后的key（文件名）。
        save_key: true,   // 默认 false。若在服务端生成uptoken的上传策略中指定了 `sava_key`，则开启，SDK会忽略对key的处理，此项配置为true可以实现同文件hash相同则不上传
        domain: '',
        ...
        init: {
            ...
            'FileUploaded': function(up, file, info) {
                ...
                // var link = url + '?e='+new Date('2015-12-12').getTime();
                // console.log(link);
    ...
    this.uploader = qnSdk.uploader(options);
};
module.exports = {
    initalize:upload,
    sdk:qnSdk
