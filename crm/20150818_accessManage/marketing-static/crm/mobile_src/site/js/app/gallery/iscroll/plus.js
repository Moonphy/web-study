...
define(function(require,exports,module) {
	...
	module.exports = {
		...
		newVerScrollForPull : function(wrapper,pulldownAction,pullupAction,opts,pullText){
			...
			var scrollObj = this.newVerScroll($wrapper,wrapper,options);
		 ...
		 * @return IScroll实例对象
		 */
		newVerScroll : function(dom,wrapper,option){
			var opt = {
			...
			var iSObj = new IScroll(wrapper,opt);
